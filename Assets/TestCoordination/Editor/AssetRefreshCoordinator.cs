...
namespace TestCoordination
{
    ...
    public static class AssetRefreshCoordinator
    {
        ...
        [MenuItem("Test Coordination/Asset Refresh/Check Pending Requests")]
        public static void ManualCheckPendingRequests()
        {
            CheckForPendingRefreshRequests();
        }
        
        [MenuItem("Test Coordination/Asset Refresh/View Pending Requests")]
        ...
        [MenuItem("Test Coordination/Asset Refresh/Toggle Polling")]
        ...
        [MenuItem("Test Coordination/Asset Refresh/Force Refresh Now")]
