...
namespace TestCoordination
{
    ...
    public static class BackgroundPoller
    {
        ...
        [MenuItem("Test Coordination/Background Polling/Enable")]
        public static void MenuEnablePolling()
        {
            EnableBackgroundPolling();
        }
        
        [MenuItem("Test Coordination/Background Polling/Disable")]
        public static void MenuDisablePolling()
        {
            DisableBackgroundPolling();
        }
        
        [MenuItem("Test Coordination/Background Polling/Status")]
        ...
        [MenuItem("Test Coordination/Background Polling/Force Script Compilation")]
